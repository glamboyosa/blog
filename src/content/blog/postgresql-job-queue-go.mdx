...
In this article, we will use a Go project called <Link href="https://github.com/glamboyosa/swig">**Swig**</Link> as a practical example of how a PostgreSQL-backed job queue can work.
...
<Link href="https://swig.glamboyosa.xyz">Swig</Link> shows how far you can get with a small Go API and a few PostgreSQL features:
